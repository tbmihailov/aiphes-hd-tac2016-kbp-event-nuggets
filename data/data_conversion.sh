...
ldc_text_dir=/home/mihaylov/Programming/TAC2016/tac2016-kbp-event-nuggets-1/data/DC2016E36_TAC_KBP_English_Event_Nugget_Detection_2014-2015/data/2015/training/source
ldc_nugget_dir=/home/mihaylov/Programming/TAC2016/tac2016-kbp-event-nuggets-1/data/DC2016E36_TAC_KBP_English_Event_Nugget_Detection_2014-2015/data/2015/training/event_nugget
ldc_hopper_dir=/home/mihaylov/Programming/TAC2016/tac2016-kbp-event-nuggets-1/data/DC2016E36_TAC_KBP_English_Event_Nugget_Detection_2014-2015/data/2015/training/event_hopper


#change the following lines to your desired output folder
brat_output_dir=/home/mihaylov/Programming/TAC2016/tac2016-kbp-event-nuggets-1/data/DC2016E36_TAC_KBP_English_Event_Nugget_Detection_2014-2015/data/2015/training/bratNuggetAnn
brat_output_dir_hopper=/home/mihaylov/Programming/TAC2016/tac2016-kbp-event-nuggets-1/data/DC2016E36_TAC_KBP_English_Event_Nugget_Detection_2014-2015/data/2015/training/bratHopperAnn
...
java -jar bin/converter-1.0.3-jar-with-dependencies.jar -t "$ldc_text_dir" -te "txt" -a "$ldc_hopper_dir" -ae "event_hoppers.xml" -o "$brat_output_dir_hopper"
echo "Running tokenizer..."
java -jar bin/token-file-maker-1.0.4-jar-with-dependencies.jar -a "$brat_output_dir" -t "$brat_output_dir" -e "txt" -o "$token_table_dir"
echo "Converting to TBF format"
