...
runnh=run_ex4444_et38_incl2015eval_detect_events_v4_bilstm_v4
echo ${runnh}
nohup bash ex4_detect_events_v4_bilstm_v4_posdep_stacked_run_server_et18_incl2015eval.sh > ${runnh}.out 2> ${runnh}.err < /dev/null &
