...
run_name_base="run_ex7_v6_et18_tac2016_2cl_t1"
# -incl_deptokenemb_in:${incl_deptokenemb_in} -incl_deptokenemb_out:${incl_deptokenemb_out}
...
run_name="${run_name_base}_bilstm${lstm_hidden_size}_lr${learning_rate}_bs${batch_size}_layers${lstm_layers}_lowcase${lowercase}"
...
. detect_events_v6_bilstm_v6_posdep_stacked_depattention_run_server_partial.sh > ${log_file}
