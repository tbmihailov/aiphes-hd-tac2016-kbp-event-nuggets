...
runnh=run_et38_class_realis_v2_tr1415_e2015
echo ${runnh}
nohup bash classify_eventtype_and_realis_v1_baseline_run_realis_server.sh ${runnh} > ${runnh}.out 2> ${runnh}.err < /dev/null &
