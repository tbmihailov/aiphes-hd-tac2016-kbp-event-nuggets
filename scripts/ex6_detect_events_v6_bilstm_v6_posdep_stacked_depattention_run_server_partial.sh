...
# exec_script=tac_kbp/ex6_detect_events_v6_bilstm_v6_posdep_stacked_depattention.py
exec_script=tac_kbp/detect_events_v6_bilstm_v6_posdep_stacked_depattention_eventtypes.py
