...
runnh=run_ex5_et38_detect_events_v4_bilstm_v4
echo ${runnh}
nohup bash ex5_detect_events_v4_bilstm_v4_posdep_stacked_run_server_et38.sh > ${runnh}.out 2> ${runnh}.err < /dev/null &
