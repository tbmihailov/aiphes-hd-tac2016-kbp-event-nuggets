...
runnh=run_depatt_te38_tr1515_ev2015_nofilter
echo ${runnh}
nohup bash detect_events_v6_bilstm_v6_posdep_stacked_depattention_run_server.sh ${runnh} > ${runnh}.out 2> ${runnh}.err < /dev/null &
